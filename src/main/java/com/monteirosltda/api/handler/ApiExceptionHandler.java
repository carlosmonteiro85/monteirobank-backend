package com.monteirosltda.api.handler;
...
import com.monteirosltda.domain.exception.ValidacaoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    public ResponseEntity<?> handleImportacao(NegocioException ex, WebRequest request) {
    ...
    public ResponseEntity<?> handleEntidadeNaoEncontrada(ObjectNotFoundException ex, WebRequest request) {
